...
export const ConfirmationAlertContextProvider: FC<ConfirmationAlertContextProviderProps> = ({children}) => {
    ...
    return (
        <>
            <ConfirmationAlertContext.Provider value={onOpen} children={children}/>
            <ConfirmationAlert show={!!confirmationState} onHide={onClose} onConfirm={onConfirm}
                               title={confirmationState?.title} message={confirmationState?.message}/>
        </>
    );
};
