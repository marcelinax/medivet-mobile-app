            ...
            <View style={alertStyles.modalContainer}>
                <View style={alertStyles.modal}>
                    ...
                    <View style={alertStyles.buttonsContainer}>
                        <Button title={buttonsTranslations.CONFIRM} color='primary' onPress={onConfirm}
                                variant='solid' style={alertStyles.button}/>
                        <Button title={buttonsTranslations.CANCEL} color='danger' onPress={onHide}
                                variant='solid' style={[alertStyles.button, alertStyles.secondButton]}/>
                    </View>
                </View>
            </View>
        </Modal>
