...
export const UserSpecializationList = () => {
    ...
    const renderSpecialization: ListRenderItem<VetSpecialization> = ({item}) => <UserSpecializationListItem
        vetSpecialization={item}/>

    return <SimpleList data={user?.specializations || []} renderItem={renderSpecialization}
                       separateOptions/>
};
